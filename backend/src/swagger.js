const endpointDocs = [
  ...
  { method: 'put', path: '/api/tickets/{id}', summary: 'Update ticket', params: { id: '1' }, body: { title: 'Laptop will not start', description: 'Updated from API docs.', priority: 'High', category: 'Hardware' } },
  ...
  { method: 'put', path: '/api/customers/{id}', summary: 'Update customer', params: { id: '1' }, body: { name: 'Jane Customer', email: 'jane@example.com', company: 'Acme Updated' } },
  ...
  { method: 'post', path: '/api/jobs', summary: 'Queue background job', body: { type: 'email', payload: { message: 'Follow up with customer' } } },
];
...
function buildSwaggerSpec(port = 4000) {
  ...
  return {
    ...
    info: {
      title: 'Helpdesk API',
      version: '1.0.0',
      description: 'Focused documentation with 27 practical endpoints for testing the helpdesk project.',
    },
